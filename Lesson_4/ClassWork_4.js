...
function numberMinimum(a, b, c) {
    if (a < b && a < c) {
        document.write('Найменьше число: ' + a + '<br/>');
    } else if (b < c && b < a) {
        document.write('Найменьше число: ' + b + '<br/>');
    } else if (c < a && c < b) {
        document.write('Найменьше число: ' + c + '<br/>');
    }
}
